...
<Card.Text>
  <div className="d-flex justify-content-between align-items-start">
    <div>
      ...
      {!userEmailVerified ? <span className="text-danger">(Not Verified)</span> : <span className="text-success">(Verified)</span>}
    </div>
    <Button
      className="main__btn"
      onClick={openModal}
    >
      Verify Email
        ...
        <Card.Footer className="d-flex align-items-center">
          ...
          <PasswordModal show={showPasswordModal} setShow={setShowPasswordModal} handleChangePassword={handleChangePassword} />
        </Card.Footer>
      </Card>
      ...
      <MainModal emailAddress="Sample.email@gmail.com" showModal={showModal} setShowModal={setShowModal} handleCloseAlert={handleCloseAlert} setUserEmailVerified={setUserEmailVerified}/>
    </Container>
  );
};
